...
public class ReportPanelView extends javax.swing.JPanel {
    ...
    public void setSummary(BigDecimal totalService, BigDecimal totalPurchase) {
        totalServiceLabel.setText("Total Pemasukan Servis: " + MoneyUtil.format(totalService));
        totalPurchaseLabel.setText("Total Pengeluaran Pembelian: " + MoneyUtil.format(totalPurchase));
        BigDecimal profit = totalService.subtract(totalPurchase);
    ...
    private void initComponents() {
        ...
        totalServiceLabel.setText("Total Pemasukan Servis: Rp 0");
        summaryPanel.add(totalServiceLabel);
        totalPurchaseLabel.setFont(new java.awt.Font("Segoe UI", 1, 13));
        totalPurchaseLabel.setText("Total Pengeluaran Pembelian: Rp 0");
